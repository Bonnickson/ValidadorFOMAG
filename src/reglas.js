...
const REGLAS_ARCHIVO_2_CAPITAL = {
    ...
    CH: { debeContener: "CURACION", igualarConFechas: false },
...
const REGLAS_ARCHIVO_2_FOMAG = {
    ...
    CH: {
        debeContener: "CURACION DE HERIDAS",
        igualarConFechas: true,
        extraerNumero: true,
    },
    PSI: {
...
export function obtenerReglasEvento(convenio) {
    ...
    return {
        ...
        CH: { "2.pdf": reglas2.CH || reglas2.ENF, "5.pdf": REGLAS_ARCHIVO_5.CH },
...
export function obtenerReglasPaquete(convenio) {
    ...
    return {
        ...
        CH: { "2.pdf": reglas2Paquete.CH || reglas2Paquete.ENF, "5.pdf": reglas5Paquete.CH },
